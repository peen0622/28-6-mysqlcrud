...
<html>
	<head>
		<title>Employ Addr update</title>
		<meta charset="EUC-KR">
		...
		<div class="limiter">
			<div class="container-login100" style="background-image: url('<%= request.getContextPath() %>/images/bg-01.jpg');">
				<div class="wrap-login100 p-t-30 p-b-50">
					...
					<form class="login100-form validate-form p-b-33 p-t-5" action="<%= request.getContextPath() %>/Employ/updateAddrEmployAction.jsp?no=<%=no %>" method="post">
						<div class="wrap-input100 validate-input" data-validate = "Enter username">
							<input class="input100" type="text" name="employAddrContent" placeholder="Employ addr" value="<%=ea.getEmployAddrContent()%>">
