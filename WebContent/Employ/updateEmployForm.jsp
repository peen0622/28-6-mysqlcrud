		...
		<div class="limiter">
			<div class="container-login100" style="background-image: url('<%= request.getContextPath() %>/images/bg-01.jpg');">
				<div class="wrap-login100 p-t-30 p-b-50">
					...
					<form class="login100-form validate-form p-b-33 p-t-5" action="<%= request.getContextPath() %>/Employ/updateEmployAction.jsp?no=<%=no %>" method="post">
						<div class="wrap-input100 validate-input" data-validate = "Enter username">
							<input class="input100" type="text" name="employName" placeholder="Employ name" value="<%=e.getEmployName()%>">
							<span class="focus-input100" data-placeholder="&#xe82a;"></span>
						</div>
	
						<div class="wrap-input100 validate-input" data-validate="Enter password">
							<input class="input100" type="text" name="employAge" placeholder="Employ age" value="<%=e.getEmployAge()%>">
							<span class="focus-input100" data-placeholder="&#xe80f;"></span>
						</div>
