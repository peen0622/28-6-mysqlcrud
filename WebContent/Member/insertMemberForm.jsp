		...
		<div class="limiter">
			<div class="container-login100" style="background-image: url('<%= request.getContextPath() %>/images/bg-01.jpg');">
				<div class="wrap-login100 p-t-30 p-b-50">
					<span class="login100-form-title p-b-41">Member Insert</span>
					
					<form class="login100-form validate-form p-b-33 p-t-5" action="<%= request.getContextPath() %>/Member/insertMemberAction.jsp" method="post">
						...
						<div class="wrap-input100 validate-input" data-validate="Enter password">
							<input class="input100" type="text" name="memberAge" placeholder="Member age">
							<span class="focus-input100" data-placeholder="&#xe80f;"></span>
						</div>
