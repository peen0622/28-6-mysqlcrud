...
<html>
	<head>
		<title>Member Addr Update</title>
		<meta charset="EUC-KR">
	...
	<body>
		...
		System.out.println(no +" : 번호");
			...
			MemberAddr ma = mdao.updateAddrMemberForm(no,addrno);
		%>
		<div class="limiter">
			<div class="container-login100" style="background-image: url('<%= request.getContextPath() %>/images/bg-01.jpg');">
				<div class="wrap-login100 p-t-30 p-b-50">
					<span class="login100-form-title p-b-41">Addr Update</span>
					
					<form class="login100-form validate-form p-b-33 p-t-5" action="<%= request.getContextPath() %>/Member/updateAddrMemberAction.jsp?no=<%=no %>&addrno=<%=addrno%>" method="post">
						<div class="wrap-input100 validate-input" data-validate = "Enter username">
							<input class="input100" type="text" name="memberAddrContent" placeholder="Member addr" value="<%=ma.getMemberAddrContent()%>">
