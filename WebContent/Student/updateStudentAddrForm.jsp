...
<html>
	...
	<%@ include file = "/module/top.jsp" %>
		<%
			...
			StudentAddr studentAddr = studentAddrDao.updateStudentAddrForm(addrNo);
		%>
		...
		<div class="limiter">
			<div class="container-login100" style="background-image: url('<%= request.getContextPath() %>/images/bg-01.jpg');">
				<div class="wrap-login100 p-t-30 p-b-50">
					...
					<form class="login100-form validate-form p-b-33 p-t-5" action="<%=request.getContextPath() %>/Student/updateStudentAddrAction.jsp?no=<%=no%>&addrNo=<%=addrNo%>" method="post">
						<div class="wrap-input100 validate-input" data-validate = "Enter username">
							<input class="input100" type="text" name="studentAddrContent" value="<%=studentAddr.getStudentAddrContent()%>">
							<span class="focus-input100" data-placeholder="&#xe82a;"></span>
						</div>
	
						<div class="container-login100-form-btn m-t-32">
							<button class="login100-form-btn">주소 수정</button>
						</div>
					</form>
				</div>
			</div>
